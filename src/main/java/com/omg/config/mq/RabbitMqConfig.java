...
public class RabbitMqConfig {
    ...
    @Bean
    public FanoutExchange omgExchange(){
        return new FanoutExchange("omg.test.exchange.fan");
    }

    @Bean
    public Queue omgQueue(){
        return new Queue("omg.test.queue.fan");
    }

    @Bean
    public Queue omgQueue1(){
        return new Queue("omg.test.queue1.fan");
    }

    @Bean
    public Binding bingKey(FanoutExchange omgExchange,Queue omgQueue){
        return BindingBuilder.bind(omgQueue).to(omgExchange);
    }

    @Bean
    public Binding bingKey1(FanoutExchange omgExchange,Queue omgQueue1){
        return BindingBuilder.bind(omgQueue1).to(omgExchange);
    }
    ...
    public Queue businessQueueA(){
        ...
        args.put("x-message-ttl",20000L);//延时20s
